...
import ClientPart from "@/app/components/ClientPart";

export default function ClientPage({ offers }) {
    const [isExpired, setIsExpired] = useState(false)
    const [selectedOffer, setSelectedOffer] = useState(null)
    const theBestOffer = offers.find(o => o.is_best)
    const otherOffers = offers.filter(o => !o.is_best)
    const handleTimeout = () => {
        setIsExpired(true)
    }
                        ...
                        ">
                            ...
                            ">
                                    <OfferCard
                                        ...
                                        isSelected={selectedOffer === theBestOffer}
                                        isExpired={isExpired}
